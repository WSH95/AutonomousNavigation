...
#ifndef __lcm_monitor_odometer_hpp__
#define __lcm_monitor_odometer_hpp__
...
int lcm_monitor_odometer::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcm_monitor_odometer::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int lcm_monitor_odometer::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t lcm_monitor_odometer::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* lcm_monitor_odometer::getTypeName()
{
    return "lcm_monitor_odometer";
}

int lcm_monitor_odometer::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcm_monitor_odometer::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
{
    uint64_t hash = 0xaa43ec7ff3147ed6LL;
